    ...
    return (
        <div style={{ 
            ...
            <Container fluid className="py-5">
                ...
                {(searchTerm || filterCategory || sortOption) && (
                    <div className="d-flex justify-content-between align-items-center mb-4" style={{
                        ...
                        <span className="text-muted">
                            Showing {filteredAndSortedOrchids.length} of {orchids.length} orchids (filtered)
                        </span>
                        <Button 
                ...
                {/* Display filtered and sorted orchids */}
                ...
                {filteredAndSortedOrchids.length === 0 && (
                    <div className="text-center py-5">
                        <div style={{
                            ...
                            <h4 style={{ color: '#495057', marginBottom: '1rem' }}>🔍 No orchids found</h4>
